        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <Card className="flex flex-grow flex-col items-center p-8 w-full bg-gradient-to-b from-blue-700 to-indigo-500">
            ...
            <div className=" font-light text-white text-muted-foreground">
              ...
              <p className="text-center">
                Effortlessly track your workouts and monitor your progress over
                time. Whether you&apos;re a beginner or a seasoned fitness
                enthusiast, our intuitive workout tracking feature allows you to
                set personalized goals, log your activities, and visualize your
                achievements. Stay motivated and accountable as you take charge
          ...
          <Card className="flex flex-grow flex-col items-center p-8 w-full bg-gradient-to-b from-blue-700 to-indigo-500">
            ...
            <div className="space-y-2 font-light text-white text-muted-foreground">
              <CardTitle className="mb-6">
                Set Customized Workout Plans
              </CardTitle>
              <p className="text-center">
                Create personalized routines with GatorGains. Customize workouts
                to match your fitness level, goals, and schedule. Our app
                empowers you to tailor your exercise regimen according to your
                preferences and objectives, ensuring that your workouts are
          ...
          <Card className="flex flex-grow flex-col items-center p-8 w-full bg-gradient-to-b from-blue-700 to-indigo-500">
            ...
            <div className="space-y-2 font-light text-white text-muted-foreground">
              ...
              <p className="text-center">
                Utilize automated workout plans tailored to your fitness goals,
                preferences, and experience level. Whether you&apos;re looking
                to build strength, improve endurance, or lose weight, our app
                generates customized routines based on your input, including
                your experience level to help you get ready for your workout.
              </p>
            </div>
          </Card>
        </div>
