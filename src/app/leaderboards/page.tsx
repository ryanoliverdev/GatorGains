    ...
    return (
      <div className="container my-6 space-y-6">
        <div className='flex justify-center items-center mb-12 mt-12'>
          <h1 className="animatedText font-bold text-4xl sm:text-6xl drop-shadow-md">Leaderboard</h1>
          <h1 className="animatedTrophy font-bold text-4xl sm:text-5xl drop-shadow-md">🏆</h1>
        </div>
